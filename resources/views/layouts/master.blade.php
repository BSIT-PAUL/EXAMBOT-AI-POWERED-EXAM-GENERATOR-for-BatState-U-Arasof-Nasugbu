...
<head>
    ...
    <title>EXAMBOT</title>
    <link rel="shortcut icon" href="{{ URL::to('assets/img/EXAMBOT-login.png') }}">
...
<body>
    <div class="main-wrapper">
        <div class="loader" id="loadingSpinner">
            <img src="{{ URL::to('assets/img/exambot-uploading.gif') }}" alt="Loading...">
        </div>
        <div class="header">
            <div class="header-left">
                <a href="{{ route('logout') }}" class="logo">
                    <img src="{{ URL::to('assets/img/exambot-logo.png') }}" alt="Logo">
                </a>
                <a href="{{ route('logout') }}" class="logo logo-small">
                    <img src="{{ URL::to('assets/img/exambot-login.png') }}" alt="Logo" width="30" height="30">
                </a>
            </div>
        ...
        @yield('content')
        <footer>
            <p>Copyright ©  <?php echo date('Y'); ?> EXAMBOT.</p>
        </footer>
