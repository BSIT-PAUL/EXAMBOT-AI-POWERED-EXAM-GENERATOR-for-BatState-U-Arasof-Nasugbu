                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <select class="form-control select @error('section') is-invalid @enderror" name="section">
                                                ...
                                                <option value="3201 - BA" {{ old('section') == '3201 - BA' ? "selected" :""}}>3201 - BA</option>
                                                <option value="3202 - BA" {{ old('section') == '3202 - BA' ? "selected" :""}}>3202 - BA</option>
                                                <option value="3201 - NT" {{ old('section') == '3201 - NT' ? "selected" :""}}>3201 - NT</option>
                                                <option value="3202 - NT" {{ old('section') == '3202 - NT' ? "selected" :""}}>3203 - NT</option>
                                            </select>
                                            @error('section')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
